...
const findAllByDate = (modelName, dateConfig, filter) => {
...
const executeTransaction = (transactionName, ...data) => {
  ...
  return transaction(mongoose, execute, ...data);
};

const executeAggregation = (aggregationName, ...data) => {
