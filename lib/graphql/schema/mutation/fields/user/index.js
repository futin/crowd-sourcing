...
const addUser = {
  type: UserType,
  description: 'Add manually Zilker user to the app.',
  args: {
...
const updateUser = {
  type: UserType,
  description: 'Update current Zilker user. Find user by an email or username. Only fullName and roles can be updated.',
  args: {
...
const deleteUser = {
  type: GraphQLString,
  description: 'Delete Zilker user by username or email',
  args: {
    username: { type: GraphQLString },
    email: { type: GraphQLString },
  },
