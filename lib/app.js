...
// internal modules
const {
  passportAuthMiddleware, graphqlMiddleware, errorMiddleware, authUserMiddleware,
} = require('./middlewares');
const { authRoutes } = require('./routes');
const {
  mongodb: { setup: setupMongoose },
} = require('./databases');
const {
  settings,
  constants: {
...
const setupGraphql = (app) => {
  ...
  app.use('/api', (...args) => passportAuthMiddleware(passport)(...args), graphqlMiddleware);
