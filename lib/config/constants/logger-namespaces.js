...
const loggerNamespaces = {
  ...
  updateNominationTransactionNamespace: 'crowd-sourcing:databases:mongodb:connector:transactions:nominations:update-nomination-transaction',
  insertNominationTransactionNamespace: 'crowd-sourcing:databases:mongodb:connector:transactions:nominations:insert-nomination-transaction',
  ...
  updateNominationUtilsNamespace: 'crowd-sourcing:graphql:schema:mutation:fields:nomination:utils:update-nomination-utils',
};
